...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "close":
        ...
        await query.edit_message_media(
            InputMediaPhoto("https://graph.org/file/b1b3f3903c646cde2ebfe-2f7b2df66cddfc8375.jpg", 
                            ABOUT_TXT.format(
                                botname = client.name,
                                ownername = ownername, 
                            )
